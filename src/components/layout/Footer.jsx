...
const Footer = () => {
  return (
    <div className='flex mx-auto text-center text-xm md:text-md lx:text-lg justify-center h-full my-0 align-center py-2 capitalize shadow-lg dark:bg-black bg-neutral-200 dark:border-t-2 dark:border-stone-500 '>
